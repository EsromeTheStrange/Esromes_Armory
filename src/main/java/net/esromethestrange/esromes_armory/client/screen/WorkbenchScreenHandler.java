...
public class WorkbenchScreenHandler extends ScreenHandler {
    ...
    public WorkbenchScreenHandler(int syncId, PlayerInventory inventory, WorkbenchData data){
        this(syncId, inventory, inventory.player.getWorld().getBlockEntity(data.blockPos()));
    }

    public WorkbenchScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity){
        super(ArmoryScreenHandlers.WORKBENCH_SCREEN_HANDLER, syncId);
