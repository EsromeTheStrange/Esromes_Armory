...
public class ArmoryColorProvider {
    public static void register(){
        MaterialItem.MATERIAL_ITEMS.forEach(materialItem -> {
            ColorProviderRegistry.ITEM.register((itemStack, tintIndex) -> getColor(materialItem, itemStack, tintIndex), (Item) materialItem);
        });
    }

    public static int getColor(MaterialItem materialItem, ItemStack stack, int tintIndex){
