...
public class ArmoryItems {
    ...
    public static final Item TOOL_HANDLE = registerItem("tool_handle", new PartItem(new Item.Settings(), ArmoryTags.Materials.WOOD).setBaseFuelTime(100));
    public static final Item TOOL_BINDING = registerItem("tool_binding", new PartItem(new Item.Settings(), ArmoryTags.Materials.BINDING).setBaseFuelTime(100));

    public static final Item SHOVEL_HEAD = registerItem("shovel_head", new PartItem(new Item.Settings(), ArmoryTags.Materials.METAL));
    public static final Item PICKAXE_HEAD = registerItem("pickaxe_head", new PartItem(new Item.Settings(), ArmoryTags.Materials.METAL));
    public static final Item AXE_HEAD = registerItem("axe_head", new PartItem(new Item.Settings(), ArmoryTags.Materials.METAL));
    public static final Item HOE_HEAD = registerItem("hoe_head", new PartItem(new Item.Settings(), ArmoryTags.Materials.METAL));

    public static final Item SWORD_GRIP = registerItem("sword_grip", new PartItem(new Item.Settings(), ArmoryTags.Materials.WOOD));
    public static final Item SWORD_GUARD = registerItem("sword_guard", new PartItem(new Item.Settings(), ArmoryTags.Materials.METAL));
    public static final Item SWORD_BLADE = registerItem("sword_blade", new PartItem(new Item.Settings(), ArmoryTags.Materials.METAL));
