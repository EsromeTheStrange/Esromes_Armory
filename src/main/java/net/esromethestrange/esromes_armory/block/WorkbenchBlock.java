...
public class WorkbenchBlock extends BlockWithEntity implements BlockEntityProvider {
    VoxelShape LEG_MXMZ = Block.createCuboidShape(2,0,2,4, 14,4);
    VoxelShape LEG_MXPZ = Block.createCuboidShape(2,0,12,4, 14,14);
    VoxelShape LEG_PXPZ = Block.createCuboidShape(12,0,12,14, 14,14);
    VoxelShape LEG_PXMZ = Block.createCuboidShape(12,0,2,14, 14,4);
